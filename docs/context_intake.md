...
| F-010 | `docs/context/rtcl-meeting-prep.md` | Real-time interest details | Strong interest in constrained scheduling and deadline/accuracy trade-offs in AI inference tasks | High | Yes | Study | No | Good anchor for recurring study entries |
